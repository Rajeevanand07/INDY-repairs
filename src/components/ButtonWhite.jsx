  ...
  return (
    <div className="flex">
      ...
      >
        ...
        <span className="capitalize whitespace-nowrap font-semibold text-black text-md group-hover:translate-x-[-30%] bg-transparent transition-all duration-500 ease-in-out">
